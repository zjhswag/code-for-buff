...
//     }
   ...
   if(textContains("保密").exists())                   
    {     
        ...
        else if(textContains("奈芙蒂斯").exists()||textContains("阿佩普之").exists()||textContains("小绿怪").exists()||textContains("） | 赛博").exists()||textContains("） | 童话城堡").exists()||textContains("） | 小绿").exists()||textContains("7 | 童话城堡").exists()||textContains("） | 变态杀戮").exists()||textContains("） | 野孩子").exists()||textContains("） | 弗卢").exists()||textContains("） | 四号栖息地").exists()||textContains("3 | 四号栖息地").exists()||textContains("） | 焚烬之鳄").exists()||textContains("） | 行刑者").exists()||textContains("0 | 变态杀戮").exists()||textContains("5 | 野孩子").exists()||textContains("7 | 红线").exists()||textContains("P | 金粉").exists())//
        {
         buy018();
         buy019();
         buy020();
