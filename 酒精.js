...
//     }
   ...
   if(textContains("保密").exists())                   
    {     
        if(textContains("） | 奥林匹").exists()||textContains("黑莲花").exists()||textContains("鹰 | 机械工业").exists()||textContains("0 | 血s腥").exists()||textContains("） | 至尊威龙").exists()||textContains("鹰（StatTrak™） | 机械工业").exists()||textContains("死神").exists()||textContains("水灵").exists()||textContains("富兰克林").exists()||textContains("龙王").exists()||textContains("渐变琥珀").exists()||textContains("破碎铅秋").exists()||textContains("遥控").exists()||textContains("法玛斯（StatTrak™） | 机械工业").exists()||textContains("斯 | 机械工业").exists()||textContains("速度激情").exists()||textContains("7 | 卡特尔").exists()||textContains("0 | 卡特尔").exists()||textContains("宁静").exists()||textContains("珊瑚树").exists()||textContains("死亡轮回").exists()||textContains("阴谋").exists()||textContains("型 | 水灵").exists()||textContains("幻影破坏者").exists()||textContains("250（StatTrak™） | 卡特尔").exists()||textContains("三角").exists()||textContains("古董枪").exists()||textContains("混沌点阵").exists()||textContains("梅红时刻").exists()||textContains("残影").exists()||textContains("曼海蒂").exists()||textContains("守护者").exists()||textContains("红色层压").exists()||textContains("电子蜂巢").exists()||textContains("45（StatTrak™） | 动量").exists()||textContains("5 | 动量").exists()||textContains("血清").exists()||textContains("暗潮").exists()||textContains("脑洞大开").exists()||textContains("孟加拉猛虎").exists()||textContains("复仇者").exists()||textContains("0 | 心脏打击").exists()||textContains("P | 红线").exists()||textContains("凯门鳄").exists()||textContains("控制台").exists()||textContains("溅射果").exists()||textContains("0 | 往日行动").exists()||textContains("） | 狩猎利器").exists()||textContains("4 | 死寂").exists()||textContains("） | 血腥运动").exists()||textContains("） | 零食派对").exists()||textContains("） | 卡特尔").exists()||textContains("斯 | 熔化").exists()||textContains("0 | 凝视").exists()||textContains("G | 汪之").exists()||textContains("0 | 次时代").exists()||textContains("4 | 地狱烈焰").exists()||textContains("毒蛇袭击").exists()||textContains("P | 浮生如梦").exists()||textContains("相柳").exists()||textContains("原子合金").exists()
        )
        
        // ||textContains("原子合金").exists()||textContains("5 | 黄夹").exists()||textContains("3 | 次时代").exists()textContains("4 | 死寂").exists()||||textContains("G | 湖怪鸟").exists()||textContains("破颚者").exists()||textContains("5 | 动量").exists()||textContains("星 | 暴怒野兽").exists()||textContains("） | 玩具盒子").exists()||textContains("浮生如梦").exists()||textContains("相柳").exists()||textContains("D | 磷光体").exists()
        ...
        else if(textContains("精雕").exists()||textContains("4 | 焚烬之鳄").exists()||textContains("AUG | 动量").exists()||textContains("AUG（StatTrak™） | 动量").exists()||textContains("R | 经济").exists()||textContains("） | 经济").exists()||textContains("0 | 代").exists()||textContains("） | 樱花").exists()||textContains("0 | 渐变").exists()||textContains("） | 巨铁").exists()||textContains("8 | 巨铁").exists()||textContains("1 | 弗卢").exists()||textContains("） | 荒野公主").exists()||textContains("） | 浅坟").exists()||textContains("） | 气密").exists()||textContains("） | 正义").exists()||textContains("枪 | 么么").exists()||textContains("0 | 迷人幻象").exists()||textContains("银装素裹").exists()||textContains("） | 灯神").exists()||textContains("） | 雅典娜").exists()||textContains("） | 吞噬").exists()||textContains("） | 埋葬之").exists()||textContains("） | 齿仙").exists()||textContains("） | 摩登时代").exists()||textContains("P | 金粉").exists()||textContains("） | 金粉").exists()||textContains("要抱抱").exists()||textContains("喋血战士").exists()||textContains("） | 屠杀").exists()||textContains("0 | 渐变迪斯").exists()||textContains("席德.米德").exists()||textContains("） | 湖怪鸟").exists()||textContains("） | 野蛮剑齿虎").exists()||textContains("） | 往日行动").exists()||textContains("） | 汪之").exists()||textContains("） | 梦魇").exists()||textContains("） | 黄夹").exists()||textContains("） | 次时代").exists()||textContains("0 | 玩具盒子").exists()||textContains("双涡轮").exists()||textContains("7 | 正义").exists()||textContains("意式拉力").exists())//||textContains("） | 美洲驼炮").exists()||textContains("） | 往日行动").exists()||textContains("） | 九头蛇").exists()||textContains("渐变迪斯").exists()||textContains("） | 渐变迪斯").exists()||textContains("1 | 行刑者").exists()||textContains("） | 瓜瓜").exists()||textContains("） | 幽幻深渊").exists()||textContains("斯 | 雅典娜").exists()||textContains("枪 | 吞噬").exists()
        {
         buy018();
         buy019();
         buy020();       
        ...
        else if(textContains("奈芙蒂斯").exists()||textContains("小绿怪").exists()||textContains("4 | 赛博").exists()||textContains("） | 赛博").exists()||textContains("） | 童话城堡").exists()||textContains("） | 小绿").exists()||textContains("7 | 童话城堡").exists()||textContains("） | 变态杀戮").exists()||textContains("） | 野孩子").exists()||textContains("） | 弗卢").exists()||textContains("） | 四号栖息地").exists()||textContains("3 | 四号栖息地").exists()||textContains("） | 焚烬之鳄").exists()||textContains("） | 行刑者").exists()||textContains("0 | 变态杀戮").exists()||textContains("5 | 野孩子").exists()||textContains("） | 么么").exists()||textContains("） | 迷人幻象").exists()||textContains("7 | 红线").exists())//
        {
         buy018();
         buy019();
         buy020();
        ...
        else if(textContains("阿佩普之").exists())//
        {
         buy018();
         buy019();
         buy020();
    ...
    if(textContains("血腥运动").exists()||textContains("7 | 霓虹革命").exists()||textContains("7 | 霓虹骑士").exists()||textContains("0 | 霓虹骑士").exists()||textContains("） | 霓虹骑士").exists()||textContains("变色龙").exists()||textContains("0 | 生化短").exists()||textContains("怒氓").exists()||textContains("战场之星").exists()||textContains("沙漠精英").exists()||textContains("荒野反叛").exists()||textContains("维多利亚").exists()||textContains("牛（StatTrak™） | 阿努比").exists()||textContains("牛 | 阿努比").exists()||textContains("7 | 阿努比").exists()||textContains("北海巨妖").exists()||textContains("渐变之色").exists()||textContains("火灵").exists()||textContains("射线").exists()||textContains("炎龙").exists()||textContains("弹雨").exists()||textContains("伽玛多普勒").exists()||textContains("纪念").exists()||textContains("次时代").exists()||textContains("喵之").exists()||textContains("无畏").exists()||textContains("水中之血").exists()||textContains("版 | 黑色").exists()||textContains("P | 黑色").exists()||textContains("AWP（StatTrak™） | 黑色魅影").exists()||textContains("7 | 美洲").exists()||textContains("抽象派").exists()||textContains("1 | 二西莫").exists()||textContains("P | 迷人眼").exists()||textContains("喧嚣杀").exists()||textContains("） | 皇家圣骑士").exists()||textContains("7（StatTrak™） | 阿努比").exists()||textContains("深海复仇").exists()||textContains("机械工业").exists()||textContains("7 | 皇后").exists()||textContains("女火神").exists()||textContains("P | 暴怒野兽").exists())//||textContains("4 | 黑色魅影").exists()||textContains("P90（StatTrak™） | 二西莫").exists()||textContains("7（StatTrak™） | 阿努比").exists()||textContains("7 | 暴怒野兽").exists()||textContains("防滚架").exists()||textContains("USP 消音版（StatTrak™） | 黑色魅影").exists()||textContains("鹰 | 印花集").exists()
        ...
        else if(textContains("4 | 反冲精英").exists()||textContains("P250（StatTrak™） | 二西莫").exists()||textContains("） | 潜行").exists()||textContains("合纵").exists()||textContains("夜愿").exists()||textContains("皇帝").exists()||textContains("星使").exists()||textContains("） | 倒吊").exists()||textContains("） | 子弹皇后 ").exists()||textContains("） | 一发入魂").exists()||textContains("型（StatTrak™） | 黑色魅影").exists())//||textContains("迷人眼").exists()||textContains("女火神").exists()||textContains("7 | 一发入魂").exists()||textContains("二号玩家").exists()
        {
         buy018();
         buy019();
         buy020();
