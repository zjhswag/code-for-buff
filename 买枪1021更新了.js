...
//
    ...
    //||textContains("星 | 黑暗").exists()||textContains("塔 | 藏身处").exists()
        ...
        else  if(textContains("核子反应").exists()||textContains("困兽之斗").exists()||textContains("凤凰徽记").exists()||textContains("午夜凶匪").exists()||textContains("核子剧毒").exists()||textContains("碾骨机").exists()||textContains("雪茄盒").exists()||textContains("沙漠之花").exists()||textContains("八音盒").exists()||textContains("紫色 DDPAT").exists()||textContains("安全网").exists()||textContains("迂回路线").exists()||textContains("碧藤青翠").exists()||textContains("AR | 渐变琥珀").exists()||textContains("潜藏者").exists()||textContains("星 | 流沙").exists()||textContains("蔚蓝多").exists()||textContains("上古图腾").exists()||textContains("人造卫星").exists()||textContains("G | 渐变琥珀").exists()||textContains("7 | 银白石英").exists()||textContains("斯 | 摧枯拉朽").exists()||textContains("尼罗河").exists()||textContains("9 | 落日").exists()||textContains("7 | 神").exists()||textContains("多变迷彩").exists()||textContains("钢铁三角").exists())//||textContains("全球攻势").exists()||textContains("气泡流行").exists()||textContains("冥界之河").exists()
        {
        toast("sp");
        buy001();
        breakbuy();
