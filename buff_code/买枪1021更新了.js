...
//
    ...
    //||textContains("） | 岩浆").exists()
        ...
        else if(textContains("） | 轻空").exists()||textContains("） | 绣蚀之刃").exists()||textContains("） | 焰色反应").exists()||textContains("） | 污染物").exists()||textContains("） | 战术手电").exists()||textContains("） | 污染物").exists()||textContains("） |大怪兽").exists()||textContains("） | 青铜装饰").exists()||textContains("） | 冰冠").exists()||textContains("） | 橙光冲击").exists()||textContains("） | 鬼影").exists()||textContains("） | 通风机").exists()||textContains("） | 声呐").exists()||textContains("） | Exo").exists()||textContains("） | 迷之宫").exists()||textContains("） | 装甲核心").exists()||textContains("） | 丛林滑").exists()||textContains("） | 卡带").exists()||textContains("） | 灼木").exists()||textContains("XM1014（StatTrak™） | 锈蚀烈焰").exists()||textContains("） | 先见之明").exists()||textContains("） | 暗夜活").exists()||textContains("绿色层压板").exists()||textContains("7 | 记忆碎片").exists()||textContains("9 | 安全网").exists()||textContains("鎏铜").exists()||textContains("腐朽木乃伊").exists()||textContains("春季方巾").exists())
        {
            buy001();
            buy002();
            breakbuy();
        ...
        else if(textContains("） | 小小噩梦").exists()||textContains("） | 盘根错").exists()||textContains("） | 中度威胁").exists()||textContains("） | 稳").exists()||textContains("） | 做旧手艺").exists()||textContains("MP9（StatTrak™） | 黑砂").exists()||textContains("） | 坐牢").exists()||textContains("） | 鱼长梦短").exists()||textContains("） | 猎人").exists()||textContains("） | 神秘碑文").exists()||textContains("） | 涂鸦潦草").exists()||textContains("） | 汤姆猫").exists()||textContains("） | 主机").exists()||textContains("） | 液化").exists()||textContains("） | 赛博之力").exists()||textContains("） | 羽量级").exists()||textContains("） | 至高皇帝").exists()||textContains("） | 板条箱").exists()||textContains("） | O.S").exists()||textContains("格洛克 18 型（StatTrak™） | 锈蚀烈焰").exists()||textContains("） | 青绿地形").exists()||textContains("） | 绿色陆战队").exists()||textContains("） | 动摇").exists()||textContains("） | 重金属").exists()||textContains("） | 斯康里娅").exists()||textContains("） | 短趾雕").exists()||textContains("） | 透明弹").exists()||textContains("） | 废物王").exists()||textContains("） | 碎蛋白石").exists()||textContains("） | 战吼斑纹").exists()||textContains("） | 铜绿").exists()||textContains("） | 异星世界").exists()||textContains("） | 印花板").exists()||textContains("） | 青金鳄").exists()||textContains("加利尔 AR（StatTrak™） | 黑砂").exists()||textContains("） | 三角战术").exists()||textContains("） | 退役").exists()||textContains("） | 灾难").exists()||textContains("） | 世仇").exists()||textContains("） | 元素轮廓").exists()||textContains("） | 保护色").exists()||textContains("） | 草皮").exists()||textContains("Tec-9（StatTrak™） | 蛇-9").exists()||textContains("） | 战鹰").exists()||textContains("） | 乳白象牙").exists()||textContains("） | 零点行动").exists()||textContains("） | 撕起来").exists()||textContains("） | 牵引力").exists()||textContains("） | 鼻青眼").exists()||textContains("） | 特训地图").exists()||textContains("） | 胶面花纹").exists()||textContains("） | 一目了然").exists()||textContains("） | 螺形").exists()||textContains("） | 幻影").exists()||textContains("R8 左轮手枪（StatTrak™） | 记忆碎片").exists()||textContains("） | 碧蓝斑纹").exists()||textContains("MAC-10（StatTrak™） | 阿罗哈").exists()||textContains("） | 本生灯").exists()||textContains("） | 卡特尔").exists()||textContains("） | 报应").exists()||textContains("） | 透光区").exists()||textContains("） | 钢铁禁锢").exists()||textContains("） | 死亡之舞").exists()||textContains("） | 龙之双子").exists()||textContains("） | 黑豹").exists()||textContains("） | 镁元素").exists()||textContains("） | 红巢").exists()||textContains("） | 蓝巢").exists()||textContains("） | 毁灭者").exists()||textContains("） | 碎片").exists()||textContains("） | 贾姆比").exists()||textContains("D（StatTrak™） | 沙漠精英").exists()||textContains("） | 刺青").exists()||textContains("） | 机动化").exists()||textContains("） | 重构").exists()||textContains("） | 萌猴").exists()||textContains("） | 藏身处").exists()||textContains("） | 丢把枪").exists()||textContains("） | 科林斯遗产").exists()||textContains("） | 卷云").exists()||textContains("） | 霸意大名").exists()||textContains("5 | 逮捕者").exists()||textContains("） | 沙漠精英").exists()||textContains("） | 简报").exists()||textContains("） | 叛逆").exists()||textContains("） | 锈蚀烈焰").exists()||textContains("） | 白鲑鱼").exists()||textContains("） | 琥珀冲流").exists()||textContains("） | 集装箱").exists())
        {
            toast('NOT BUY 0.01');
            breakbuy();
        }
        else  if(textContains("） |").exists()||textContains("水纹之").exists()||textContains("夜影").exists()||textContains("困兽之斗").exists()||textContains("凤凰徽记").exists()||textContains("午夜凶匪").exists()||textContains("核子剧毒").exists()||textContains("碾骨机").exists()||textContains("雪茄盒").exists()||textContains("沙漠之花").exists()||textContains("八音盒").exists()||textContains("紫色 DDPAT").exists()||textContains("安全网").exists()||textContains("迂回路线").exists()||textContains("碧藤青翠").exists()||textContains("AR | 渐变琥珀").exists()||textContains("潜藏者").exists()||textContains("星 | 流沙").exists()||textContains("蔚蓝多").exists()||textContains("上古图腾").exists()||textContains("G | 渐变琥珀").exists()||textContains("7 | 银白石英").exists()||textContains("斯 | 摧枯拉朽").exists()||textContains("尼罗河").exists()||textContains("9 | 落日").exists()||textContains("多变迷彩").exists()||textContains("钢铁三角").exists()||textContains("神袛").exists()||textContains("气泡流行").exists()||textContains("核子花园").exists())//||textContains("全球攻势").exists()||textContains("冥界之河").exists()沙鹰||textContains("血虎").exists()||textContains("大马士革").exists()
        {
        toast("sp");
        buy001();
        breakbuy();
