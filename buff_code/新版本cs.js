...
// }
    ...
    if(textContains("暮光星系").exists())
    {
        ...
        if(textContains("确认付款").findOne(3000))
        ...
        else if(textContains("梦魇").exists()||textContains("P | 珊瑚树").exists()||textContains("4 | 死寂空间").exists()||textContains("0 | 曼海蒂").exists()||textContains("型 | 毁灭者").exists())//zhi mai dao 00
            { 
                buy007();
                // toast('00 07');
                breakbuy();
            ...
            else if(textContains("） | 破颚者").exists()||textContains("0 | 珊瑚树").exists()||textContains("） | 孟加拉猛虎").exists()||textContains("9 | 九头蛇").exists()||textContains("） | 奥林匹斯").exists())//text = P2000（StatTrak™） | 珊瑚树 (略有磨损)text = AWP（StatTrak™） | 珊瑚树 (久经沙场)
            {
                buy007();
                buy008();
                // toast("00 07-08");               
        ...
        if(textContains("确认付款").findOne(3000))
            ...
            else if(textContains("原子合金").exists()||textContains("） | 燃料喷射器").exists()||textContains("AK-47（StatTrak™） | 卡特尔").exists()||textContains("猎户").exists()||textContains("） | 可燃冰").exists()||textContains("7 | 可燃冰").exists()||textContains("9 | 燃料喷射器").exists()||textContains("版 | 脑洞").exists())//zhi mai dao 001 007||textContains("型 | 毁灭者").exists()||textContains("） | 破碎铅秋").exists()
            {
...
// high prior||textContains("） | 大佬").exists()||textContains("7 | 混沌点阵").exists()
      ...
      if(textContains("确认付款").findOne(6000))
        ...
        else if(textContains("0 | 变态杀戮").exists()||textContains("5 | 野孩子").exists())
         {
          ...
          else if(textContains("枪 | 奥林匹斯").exists()||textContains("G | 动量").exists()||textContains("AUG（StatTrak™） | 动量").exists()||textContains("） | 吞噬").exists()||textContains("） | 雅典娜之眼").exists()||textContains("R | 经济").exists()||textContains("） | 汪之萌杀").exists()||textContains("） | 小绿怪").exists()||textContains("耍猴把戏").exists()||textContains("） | 荒野公主").exists()||textContains("枪 | 荒野公主").exists()||textContains("0 | 浅坟").exists()||textContains("） | 迷人幻象").exists()||textContains("） | 么么").exists()||textContains("0 | 迷人幻象").exists()||textContains("枪 | 么么").exists()||textContains("G | 湖怪鸟").exists()||textContains("牛 | 买定离手").exists()||textContains("4 | 埋葬之影").exists()||textContains("枪 | 美洲驼炮").exists())//||textContains("G | 燕群").exists()
          {    
              buy003();
              buy008();
              buy009();
  ...
  else if(textContains("法玛斯（StatTrak™） | 机械工业").exists()||textContains("狩猎利器").exists()||textContains("斯 | 机械工业").exists()||textContains("7 | 幻影破坏者").exists()||textContains("P | 浮生如梦").exists()||textContains("7 | 复仇者").exists()||textContains("星 | 樱花").exists()||textContains("） | 死神").exists()||textContains("斯 | 雅典娜之眼").exists())//text = 法玛斯（StatTrak™） | 机械工业 (略有磨损)||textContains("） | 席德.米德").exists()||
          {
            buy003();
            toast('00-03,07');
            breakbuy();
...
else if(textContains("受限").exists())//915
{
    ...
    else if(textContains("诅咒").exists()||textContains("） | 古董枪").exists()||textContains("） | 翼蜥").exists()||textContains("铁血玫瑰").exists()||textContains("牛 | 古董枪").exists()||textContains("） | 杀意大名").exists()||textContains("7 | 轨道").exists()||textContains("冥界之").exists()||textContains("林间").exists()||textContains("P | 火卫一").exists()||textContains("盲点").exists()||textContains("0 | 死亡之握").exists()||textContains("） | 蓝色层压板").exists()||textContains("星 | 惊惧骷髅").exists()||textContains("次时代").exists()||textContains("数字架构师").exists()||textContains("棱彩阶梯").exists()||textContains("斯 | 电子脉冲").exists()||textContains("） | 西装革履").exists()||textContains("） | 帝国").exists()||textContains("P | 蠕虫之神").exists()||textContains("8 | 浮生如梦").exists()||textContains("4 | 杀意大名").exists()||textContains("版 | 地狱门票").exists()||textContains("4 | 西装革履").exists()||textContains("） | 富士山").exists()||textContains("） | 深红海啸").exists()||textContains("G | 力矩").exists())//||textContains("） | 崩络克").exists()||textContains("4 | 特克卢").exists()||textContains("型 | 夜无眠").exists()
    {
       buy001();  
       toast('00-01 啊');
       breakbuy();      
    ...
    else if(textContains("） | 星级").exists()||textContains("） | 三巨头").exists()||textContains("） | 疯狂老八").exists()||textContains("） | 蚀刻领主").exists()||textContains("7 | 炽热").exists()||textContains("） | 北冥有鱼").exists())
    {
        buy008();
        buy009();    
        toast('00 07-09');
