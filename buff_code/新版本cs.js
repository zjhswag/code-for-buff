...
// }
    ...
    if(textContains("暮光星系").exists())
    {
        ...
        if(textContains("确认付款").findOne(3000))
            ...
            else if(textContains("梅红时刻").exists()||textContains("型 | 水灵").exists()||textContains("0 | 卡特尔").exists()||textContains("0 | 次时代").exists()||textContains("星 | 古董枪").exists()||textContains("守护者").exists()||textContains("） | 幻影破坏").exists()||textContains("0 | 死亡轮回").exists()||textContains("4 | 龙王").exists()||textContains("） | 龙王").exists()||textContains("） | 毁灭者").exists()||textContains("斯 | 熔化").exists()||textContains("0 | 凝视").exists())//zhi mai dao 001
            {
                //只买到001
                // toast("00-01");
                breakbuy();
            }
            else if(textContains("） | 脑洞大开").exists()||textContains("原子合金").exists()||textContains("） | 燃料喷射器").exists()||textContains("AK-47（StatTrak™） | 卡特尔").exists()||textContains("猎户").exists()||textContains("） | 可燃冰").exists()||textContains("7 | 可燃冰").exists()||textContains("屠杀者").exists()||textContains("版 | 脑洞").exists())//zhi mai dao 001 007||textContains("型 | 毁灭者").exists()||textContains("） | 破碎铅秋").exists()
            {
    ...
    if(textContains("确认付款").findOne(3000))
      ...
      else if(textContains("前线迷雾").exists()||textContains("） | 速度激情").exists()||textContains("型 | 破碎铅秋").exists()||textContains("遥控").exists()||textContains("5 | 相柳").exists())
// high prior||textContains("） | 大佬").exists()||textContains("7 | 混沌点阵").exists()
      ...
      if(textContains("确认付款").findOne(6000))
        ...
        else if(textContains("0 | 变态杀戮").exists()||textContains("5 | 野孩子").exists())
         {
          ...
          else if(textContains("红色层压板").exists()||textContains("） | 樱花").exists()||textContains("） | 燕群").exists()||textContains("G | 汪之萌杀").exists()||textContains("） | 野蛮剑齿虎").exists()||textContains("0 | 二西莫夫").exists()||textContains("银装素裹").exists()||textContains("） | 灯神").exists()||textContains("） | 席德").exists()||textContains("） | 齿仙").exists()||textContains("） | 要抱抱").exists()||textContains("0 | 至尊威龙").exists()||textContains("0 | 血腥运动").exists()||textContains("） | 血腥运动").exists()||textContains("） | 浅坟").exists()||textContains("4 | 要抱抱").exists()||textContains("） | 正义").exists()||textContains("7 | 正义").exists()||textContains("G | 燕群").exists()||textContains("P | 死神").exists()||textContains("P | 金粉").exists()||textContains("5 | 野蛮剑齿虎").exists()||textContains("枪 | 吞噬").exists()||textContains("型 | 摩登时代").exists()||textContains("4 | 齿仙").exists())      
          {
            buy003();
            buy009();
            buy008();
   ...
   else if(textContains("） | 爆裂食物").exists()||textContains("） | 摩登时代").exists()||textContains("） | 相柳").exists()||textContains("） | 大佬龙").exists()||textContains("5 | 动量").exists()||textContains("D | 磷光体").exists()||textContains("） | 买定离手").exists()||textContains("） | 美洲驼炮").exists()||textContains("） | 往日行动").exists()||textContains("G | 席德.米德").exists()||textContains("9 | 爆裂食物").exists()||textContains("鹰 | 机械工业").exists()||textContains("枪 | 荒野公主").exists())//席德
          {
            buy003(); 
            buy008();
            toast('00-03,07-08');
  ...
  else if(textContains("法玛斯（StatTrak™） | 机械工业").exists()||textContains("狩猎利器").exists()||textContains("斯 | 机械工业").exists()||textContains("7 | 幻影破坏者").exists()||textContains("P | 浮生如梦").exists()||textContains("7 | 复仇者").exists()||textContains("星 | 樱花").exists()||textContains("） | 死神").exists()||textContains("斯 | 雅典娜之眼").exists()||textContains("） | 磷光体").exists()||textContains("UMP-45（StatTrak™） | 动量").exists())//text = 法玛斯（StatTrak™） | 机械工业 (略有磨损)||textContains("） | 席德.米德").exists()||
          {
            buy003();
            toast('00-03,07');
            breakbuy();
    ...
    else if(textContains("意式拉力").exists()||textContains("0 | 玩具盒子").exists()||textContains("） | 曼海蒂").exists()||textContains("鹰 | 大佬龙").exists()||textContains("） | 迷人眼").exists()||textContains("） | 精英之作").exists()||textContains("） | 气密").exists()||textContains("三角").exists()||textContains("5 | 黄夹克").exists()||textContains("R | 迷人眼").exists()||textContains("） | 金粉").exists())//||textContains("9 | 气密").exists()||textContains("8 | 速度激情").exists()
    {
        buy008();
        toast('00-02,07-08');
        breakbuy();
    ...
    else if(textContains("3 | 次时代").exists()||textContains("0 | 精雕木刻").exists()||textContains("） | 次时代").exists()||textContains("） | 复仇者").exists()||textContains("斯 | 灯神").exists()||textContains("0 | 往日行动").exists())//||textContains("G | 燕群").exists()
    {
        buy008();
        buy009();
        toast('00-02,07-09');
...
else if(textContains("受限").exists())//915
{
    ...
    else if(textContains("7 | 北冥有鱼").exists()||textContains("5 | 猛虎").exists()||textContains("9 | 翠绿箭").exists()||textContains("4 | 四季").exists()||textContains("0 | 绝界之行").exists()||textContains("5 | 支架").exists()||textContains("） | 路霸").exists()||textContains("守护者").exists()||textContains("0 | 孔雀石").exists()||textContains("0 | 翼击").exists()||textContains("） | 七彩斑斓").exists()||textContains("7 | 七彩斑斓").exists()||textContains("5 | 金铋辉煌").exists()||textContains("8 | 抖枪").exists()||textContains("公路杀手").exists()||textContains("R | 深红海啸").exists()||textContains("0 | 权力之心").exists()||textContains("） | 翼击").exists()||textContains("） | 经济").exists()||textContains("3 | 三巨头").exists()||textContains("） | 重新启动").exists()||textContains("） | 贵族").exists()||textContains("7 | 渐变之色").exists()||textContains("7 | 翡翠细条纹").exists()||textContains("牛 | 核燃料棒").exists())//||||textContains("R | 火线冲锋").exists()||textContains("4 | 蚀刻领主").exists()||textContains("型 | 崩络克").exists()||textContains("枪 | 模拟输入").exists()||textContains("7 | 笑一个").exists()||textContains("7 | 混合体").exists()||textContains("） | 皇室伴侣").exists()||textContains("） | 树蝰").exists()
    {
        buy008();
        toast('00-01,07-08');
        breakbuy();
    }
    else if(textContains("） | 玩具士兵").exists()||textContains("葡萄酒").exists()||textContains("） | 公海").exists()||textContains("3 | 黯翼").exists()||textContains("） | 蕉").exists()||textContains("0 | 酸蚀").exists()||textContains("5 | 经济").exists()||textContains("） | 魅惑").exists())//
    {
        buy008();
        buy009(); 
        toast('00-01,07-09');
    ...
    //     breakbuy();
    // }
    else if(textContains("） | 铋晶体").exists()||textContains("7 | 铋晶体").exists()||textContains("枪 | 聚光灯").exists()||textContains("9 | 战火重").exists()||textContains("5 | 红鹰").exists()||textContains("） | 猛虎").exists()||textContains("） | 三位一体").exists()||textContains("0 | 超新星").exists()||textContains("） | 都市冲击").exists()||textContains("） | 超新星").exists()||textContains("UMP-45（StatTrak™） | 城里的月光").exists()||textContains("） | 炼狱小镇").exists()||textContains("7 | 速递").exists()||textContains("9 | 星云十字军").exists()||textContains("） | 高斯").exists()||textContains("） | 阿兹特克").exists()||textContains("） | 五彩斑驳").exists()||textContains("） | 孔雀石").exists()||textContains("0 | 渐变琥珀").exists()||textContains("） | 好兄弟").exists()||textContains("安全网").exists()||textContains("星 | 毒蜥").exists()||textContains("G | 贵族").exists()||textContains("特克卢").exists()||textContains("3 | 豹灯蛾").exists()||textContains("7 | 朝花夕").exists()||textContains("型 | 圆影").exists()||textContains("） | 核燃料棒").exists()||textContains("0 | 夺命器").exists())//
    {
        buy002();
        buy008();
        breakbuy();
    }
    else if(textContains("） | 神经网").exists()||textContains("星 | 锦鲤").exists()||textContains("5 | 城里的月光").exists()||textContains("型 | 城里的月光").exists()||textContains("D | 高斯").exists()||textContains("斯 | 神经网").exists()||textContains("） | 死亡之握").exists()||textContains("） | 战术高手").exists()||textContains("） | 青竹伪装").exists()||textContains("9 | 红宝石毒镖").exists()||textContains("） | 死亡主宰").exists()||textContains("） | 红宝石毒").exists()||textContains("） | 极地孤狼").exists()||textContains("威吓者").exists()||textContains("星 | 晶红石英").exists())//||textContains("） | 坍雪").exists()||textContains("） | 同步力场").exists()||textContains("4 | 蚀刻领主").exists()||textContains("型 | 崩络克").exists()||textContains("枪 | 模拟输入").exists()||textContains("7 | 笑一个").exists()||textContains("7 | 混合体").exists()
         {
             buy002();
             breakbuy();
             toast('00-02,07');
         }
    else if(textContains("秋季方巾").exists()||textContains("复古流行").exists()||textContains("牛 | 太空猫").exists()||textContains("牛 | 死亡主宰").exists()||textContains("5 | 战术高手").exists()||textContains("9 | 焦油缠绕").exists()||textContains("4 | 五彩斑驳").exists()||textContains("疯狂蔓延").exists()||textContains("） | 太空猫").exists()||textContains("） | ZX81").exists()||textContains("） | 红宝石毒镖").exists())//
         {
            buy002();
            buy003();
            toast('00-03,07');
