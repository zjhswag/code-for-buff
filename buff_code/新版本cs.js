...
// }
    ...
    if(textContains("暮光星系").exists())
    {
        ...
        if(textContains("确认付款").findOne(3000))
        ...
        else if(textContains("梦魇").exists()||textContains("9 | 燃料喷射器").exists()||textContains("P | 珊瑚树").exists()||textContains("4 | 死寂空间").exists()||textContains("型 | 毁灭者").exists())//zhi mai dao 00
            { 
                buy007();
                // toast('00 07');
                breakbuy();
            }
            else if(textContains("AWP（StatTrak™） | 珊瑚树").exists()||textContains("海之泡沫").exists()||textContains("钴蓝禁锢").exists()||textContains("冷血杀手").exists()||textContains("血清").exists()||textContains("富兰克林").exists()||textContains("渐变琥珀").exists()||textContains("暗潮").exists()||textContains("混沌点阵").exists()||textContains("7 | 卡特尔").exists()||textContains("黑莲花").exists()||textContains("0 | 曼海蒂").exists())//zhi mai dao 000
            {
                // toast('00');
                breakbuy();
            }
            ...
            else if(textContains("P2000（StatTrak™） | 珊瑚树").exists()||textContains("G | 孟加拉猛虎").exists()||textContains("） | 破颚者").exists()||textContains("） | 奥林匹斯").exists())
            {
                buy007();
                buy008();
                buy009();    
        ...
        if(textContains("确认付款").findOne(3000))
            ...
            else if(textContains("梅红时刻").exists()||textContains("型 | 水灵").exists()||textContains("0 | 卡特尔").exists()||textContains("0 | 次时代").exists()||textContains("星 | 古董枪").exists()||textContains("守护者").exists()||textContains("） | 幻影破坏").exists()||textContains("0 | 死亡轮回").exists()||textContains("4 | 龙王").exists()||textContains("） | 龙王").exists()||textContains("） | 毁灭者").exists()||textContains("斯 | 熔化").exists()||textContains("0 | 凝视").exists()||textContains("7 | 可燃冰").exists())//zhi mai dao 001
            {
                //只买到001
                // toast("00-01");
                breakbuy();
            }
            else if(textContains("） | 脑洞大开").exists()||textContains("原子合金").exists()||textContains("AK-47（StatTrak™） | 卡特尔").exists()||textContains("猎户").exists()||textContains("） | 可燃冰").exists()||textContains("屠杀者").exists()||textContains("版 | 脑洞").exists()||textContains("8 | 速度激情").exists())//zhi mai dao 001 007||textContains("型 | 毁灭者").exists()||textContains("） | 破碎铅秋").exists()
            {
    ...
    if(textContains("确认付款").findOne(3000))
      ...
      else if(textContains("前线迷雾").exists()||textContains("） | 速度激情").exists()||textContains("型 | 破碎铅秋").exists()||textContains("遥控").exists()||textContains("5 | 相柳").exists()||textContains("） | 燃料喷射器").exists())
// high prior||textContains("） | 大佬").exists()||textContains("7 | 混沌点阵").exists()
      ...
      else if(textContains("电子蜂巢").exists()||textContains("） | 残影").exists()||textContains("） | 宁静").exists()||textContains("沙漠之鹰（StatTrak™） | 机械工业").exists())//||textContains("5 | 相柳").exists()
      {  
        buy003();
        breakbuy();
        toast('00-03');
      ...
      if(textContains("确认付款").findOne(6000))
        ...
        else if(textContains("0 | 变态杀戮").exists()||textContains("5 | 野孩子").exists())
         {
          ...
          else if(textContains("枪 | 奥林匹斯").exists()||textContains("G | 动量").exists()||textContains("AUG（StatTrak™） | 动量").exists()||textContains("） | 吞噬").exists()||textContains("） | 雅典娜之眼").exists()||textContains("R | 经济").exists()||textContains("） | 汪之萌杀").exists()||textContains("） | 小绿怪").exists()||textContains("耍猴把戏").exists()||textContains("） | 荒野公主").exists()||textContains("0 | 浅坟").exists()||textContains("） | 迷人幻象").exists()||textContains("） | 么么").exists()||textContains("0 | 迷人幻象").exists()||textContains("枪 | 么么").exists()||textContains("G | 湖怪鸟").exists()||textContains("牛 | 买定离手").exists()||textContains("4 | 埋葬之影").exists()||textContains("枪 | 美洲驼炮").exists())//||textContains("G | 燕群").exists()
          {    
              buy003();
              buy008();
              buy009();
          ...
          else if(textContains("红色层压板").exists()||textContains("） | 樱花").exists()||textContains("） | 燕群").exists()||textContains("G | 汪之萌杀").exists()||textContains("） | 野蛮剑齿虎").exists()||textContains("0 | 二西莫夫").exists()||textContains("银装素裹").exists()||textContains("） | 灯神").exists()||textContains("） | 席德").exists()||textContains("G | 席德.米德").exists()||textContains("） | 齿仙").exists()||textContains("） | 要抱抱").exists()||textContains("0 | 至尊威龙").exists()||textContains("0 | 血腥运动").exists()||textContains("） | 血腥运动").exists()||textContains("） | 浅坟").exists()||textContains("4 | 要抱抱").exists()||textContains("） | 正义").exists()||textContains("7 | 正义").exists()||textContains("G | 燕群").exists()||textContains("P | 死神").exists()||textContains("P | 金粉").exists()||textContains("5 | 野蛮剑齿虎").exists()||textContains("枪 | 吞噬").exists()||textContains("型 | 摩登时代").exists()||textContains("4 | 齿仙").exists()||textContains("） | 往日行动").exists()||textContains("0 | 往日行动").exists())      
          {
            buy003();
            buy009();
            buy008();
   ...
   else if(textContains("） | 爆裂食物").exists()||textContains("） | 摩登时代").exists()||textContains("） | 相柳").exists()||textContains("） | 大佬龙").exists()||textContains("5 | 动量").exists()||textContains("D | 磷光体").exists()||textContains("） | 买定离手").exists()||textContains("） | 美洲驼炮").exists()||textContains("9 | 爆裂食物").exists()||textContains("鹰 | 机械工业").exists()||textContains("枪 | 荒野公主").exists()||textContains("） | 死神").exists())//席德
          {
            buy003(); 
            buy008();
            toast('00-03,07-08');
  ...
  else if(textContains("法玛斯（StatTrak™） | 机械工业").exists()||textContains("狩猎利器").exists()||textContains("斯 | 机械工业").exists()||textContains("7 | 幻影破坏者").exists()||textContains("P | 浮生如梦").exists()||textContains("7 | 复仇者").exists()||textContains("星 | 樱花").exists()||textContains("斯 | 雅典娜之眼").exists()||textContains("） | 磷光体").exists()||textContains("UMP-45（StatTrak™） | 动量").exists())//text = 法玛斯（StatTrak™） | 机械工业 (略有磨损)||textContains("） | 席德.米德").exists()||
          {
            buy003();
            toast('00-03,07');
            breakbuy();
    ...
    else if(textContains("意式拉力").exists()||textContains("0 | 玩具盒子").exists()||textContains("） | 曼海蒂").exists()||textContains("鹰 | 大佬龙").exists()||textContains("） | 迷人眼").exists()||textContains("） | 精英之作").exists()||textContains("） | 气密").exists()||textContains("三角").exists()||textContains("5 | 黄夹克").exists()||textContains("R | 迷人眼").exists()||textContains("） | 金粉").exists())//||textContains("9 | 气密").exists()
    {
        buy008();
        toast('00-02,07-08');
        breakbuy();
...
else if(textContains("受限").exists())//915
{
     ...
     else if(textContains("型 | 粉碎者").exists()||textContains("） | 轨道").exists()||textContains("型 | 粉红 DDPAT").exists()||textContains("凤凰冥灯").exists()||textContains("） | 惊惧骷髅").exists()||textContains("法玛斯（StatTrak™） | 电子脉冲").exists()||textContains("警告").exists()||textContains("黄铜").exists()||textContains("） | 粉碎者").exists()||textContains("9 | 富士山").exists()||textContains("9 | 青竹伪装").exists()||textContains("7 | 蓝色层压板").exists()||textContains("G | 极地孤狼").exists()||textContains("） | 力矩").exists()||textContains("太空竞赛").exists())
     {  
         buy001();
         buy002();
         toast('till 002');
    ...
    else if(textContains("） | 星级").exists()||textContains("） | 三巨头").exists()||textContains("） | 疯狂老八").exists()||textContains("） | 蚀刻领主").exists()||textContains("7 | 炽热").exists()||textContains("） | 北冥有鱼").exists()||textContains("塔 | 食人花").exists())
    {
        buy008();
        buy009();    
        toast('00 07-09');
    ...
    else  if(textContains("1 | 净化者").exists()||textContains("版 | 闪回").exists()||textContains("） | 赛博先锋").exists()||textContains("） | 石雕").exists()||textContains("） | 毒刺").exists()||textContains("） | 毒蜥").exists()||textContains("） | 曝光").exists()||textContains("） | 幻影").exists()||textContains("鹰 | 深红之网").exists()||textContains("9 | 闹市").exists()||textContains("3 | 青龙").exists()||textContains("0 | 给爷冲").exists()||textContains("） | 给爷冲").exists()||textContains("） | 闹市").exists()||textContains("0 | 元女王").exists()||textContains("） | 元女王").exists()||textContains("） | 兄弟连").exists()||textContains("） | 猛烈冲锋").exists()||textContains("） | 凤凰商").exists()||textContains("） | 影魔").exists()||textContains("） | 执行者").exists()||textContains("） | 启示录").exists()||textContains("） | 梦之林地").exists()||textContains("） | 行尸攻").exists()||textContains("） | 白狼").exists()||textContains("） | 狮子鱼").exists()||textContains("） | 夺命器").exists()||textContains("疾袭圣甲虫").exists()||textContains("索贝克").exists())
         {
            buy002();
            buy003();
            buy008();
    ...
    else if(textContains("7 | 北冥有鱼").exists()||textContains("5 | 猛虎").exists()||textContains("9 | 翠绿箭").exists()||textContains("4 | 四季").exists()||textContains("0 | 绝界之行").exists()||textContains("5 | 支架").exists()||textContains("） | 路霸").exists()||textContains("守护者").exists()||textContains("0 | 孔雀石").exists()||textContains("0 | 翼击").exists()||textContains("） | 七彩斑斓").exists()||textContains("7 | 七彩斑斓").exists()||textContains("5 | 金铋辉煌").exists()||textContains("8 | 抖枪").exists()||textContains("公路杀手").exists()||textContains("R | 深红海啸").exists()||textContains("0 | 权力之心").exists()||textContains("） | 翼击").exists()||textContains("） | 经济").exists()||textContains("3 | 三巨头").exists()||textContains("） | 重新启动").exists()||textContains("） | 贵族").exists()||textContains("7 | 渐变之色").exists()||textContains("7 | 翡翠细条纹").exists()||textContains("牛 | 核燃料棒").exists()||textContains("0 | 酸蚀").exists()||textContains("3 | 黯翼").exists())//||||textContains("R | 火线冲锋").exists()||textContains("4 | 蚀刻领主").exists()||textContains("型 | 崩络克").exists()||textContains("枪 | 模拟输入").exists()||textContains("7 | 笑一个").exists()||textContains("7 | 混合体").exists()||textContains("） | 皇室伴侣").exists()||textContains("） | 树蝰").exists()
    {
        buy008();
        toast('00-01,07-08');
        breakbuy();
    }
    else if(textContains("） | 玩具士兵").exists()||textContains("葡萄酒").exists()||textContains("） | 公海").exists()||textContains("） | 蕉").exists()||textContains("） | 权力之心").exists()||textContains("5 | 经济").exists()||textContains("） | 魅惑").exists())//
    {
        buy008();
        buy009(); 
        toast('00-01,07-09');
    ...
    else if(textContains("） | 灾难").exists()||textContains("） | 绝界之行").exists()||textContains("） | 翠绿箭").exists()||textContains("） | 四季").exists()||textContains("） | 支架").exists()||textContains("） | 塑胶炸弹").exists()||textContains("1 | 公海").exists()||textContains("7 | 权力之心").exists()||textContains("星 | 玩具士兵").exists()||textContains("） | 星云十字军").exists()||textContains("） | 速递").exists()||textContains("随机存取").exists()||textContains("） | 朝枪夕拾").exists()||textContains("枪 | 疯狂老八").exists()||textContains("） | 豹灯蛾").exists()||textContains("） | SWAG").exists()||textContains("枪 | 蕉").exists()||textContains("0 | 影魔").exists()||textContains("拉美").exists()||textContains("枪 | 模拟输入").exists()||textContains("7 | 笑一个").exists()||textContains("7 | 混合体").exists()||textContains("4 | 蚀刻领主").exists())
    {
        buy002();
        buy008(); 
       buy009();
    ...
    else if(textContains("） | 神经网").exists()||textContains("星 | 锦鲤").exists()||textContains("5 | 城里的月光").exists()||textContains("型 | 城里的月光").exists()||textContains("D | 高斯").exists()||textContains("） | 死亡之握").exists()||textContains("） | 战术高手").exists()||textContains("） | 青竹伪装").exists()||textContains("9 | 红宝石毒镖").exists()||textContains("） | 死亡主宰").exists()||textContains("） | 红宝石毒").exists()||textContains("） | 极地孤狼").exists()||textContains("威吓者").exists()||textContains("型 | 圆影").exists()||textContains("星 | 晶红石英").exists())//||textContains("） | 坍雪").exists()||textContains("） | 同步力场").exists()||textContains("4 | 蚀刻领主").exists()||textContains("型 | 崩络克").exists()||textContains("枪 | 模拟输入").exists()||textContains("7 | 笑一个").exists()||textContains("7 | 混合体").exists()
         {
             buy002();
             breakbuy();
             toast('00-02,07');
