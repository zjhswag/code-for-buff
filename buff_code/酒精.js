...
//     }
   ...
   if(textContains("保密").exists())                   
    ...
    if(textContains("血腥运动").exists()||textContains("5 | 霓虹革命").exists()||textContains("7 | 霓虹骑士").exists()||textContains("0 | 霓虹骑士").exists()||textContains("） | 霓虹骑士").exists()||textContains("变色龙").exists()||textContains("0 | 生化短").exists()||textContains("怒氓").exists()||textContains("战场之星").exists()||textContains("沙漠精英").exists()||textContains("荒野反叛").exists()||textContains("维多利亚").exists()||textContains("牛（StatTrak™） | 阿努比").exists()||textContains("牛 | 阿努比").exists()||textContains("7 | 阿努比").exists()||textContains("北海巨妖").exists()||textContains("渐变之色").exists()||textContains("火灵").exists()||textContains("射线").exists()||textContains("炎龙").exists()||textContains("弹雨").exists()||textContains("伽玛多普勒").exists()||textContains("纪念").exists()||textContains("次时代").exists()||textContains("喵之").exists()||textContains("无畏").exists()||textContains("水中之血").exists()||textContains("版 | 黑色").exists()||textContains("P | 黑色").exists()||textContains("AWP（StatTrak™） | 黑色魅影").exists()||textContains("7 | 美洲").exists()||textContains("抽象派").exists()||textContains("1 | 二西莫").exists()||textContains("s | 迷人眼").exists()||textContains("） | 皇家圣骑士").exists()||textContains("7（StatTrak™） | 阿努比").exists()||textContains("4 | 喧嚣杀").exists()||textContains("P | 暴怒野兽").exists())//||textContains("4 | 黑色魅影").exists()||textContains("P90（StatTrak™） | 二西莫").exists()||textContains("7（StatTrak™） | 阿努比").exists()||textContains("7 | 暴怒野兽").exists()||textContains("防滚架").exists()||textContains("USP 消音版（StatTrak™） | 黑色魅影").exists()||textContains("鹰 | 印花集").exists()||textContains("女火神").exists()||textContains("7 | 皇后").exists()||textContains("深海复仇").exists()
        ...
        else if(textContains("P250（StatTrak™） | 二西莫").exists()||textContains("） | 潜行").exists()||textContains("合纵").exists()||textContains("皇帝").exists()||textContains("星使").exists()||textContains("倒吊").exists()||textContains("型（StatTrak™） | 黑色魅影").exists()||textContains("二号玩家").exists()||textContains("女火神").exists()||textContains("版| 印花集").exists()||textContains("夜愿").exists())//||textContains("迷人眼").exists()||textContains("7 | 一发入魂").exists()||textContains("） | 子弹皇后 ").exists()
        {
         buy018();
         buy019();
         buy020();
