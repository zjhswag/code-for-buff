...
//     }
   ...
   if(textContains("保密").exists())                   
    {     
        ...
        else if(textContains("） | 精雕").exists()||textContains("4 | 焚烬之鳄").exists()||textContains("AUG | 动量").exists()||textContains("AUG（StatTrak™） | 动量").exists()||textContains("R | 经济").exists()||textContains("） | 经济").exists()||textContains("0 | 代").exists()||textContains("） | 樱花").exists()||textContains("） | 渐变迪斯").exists()||textContains("） | 巨铁").exists()||textContains("1 | 弗卢").exists()||textContains("） | 荒野公主").exists()||textContains("） | 浅坟").exists()||textContains("） | 气密").exists()||textContains("） | 正义").exists()||textContains("灯神").exists()||textContains("） | 雅典娜").exists()||textContains("） | 吞噬").exists()||textContains("） | 埋葬之").exists()||textContains("） | 齿仙").exists()||textContains("） | 摩登时代").exists()||textContains("4 | 埋葬之").exists()||textContains("4 | 齿仙").exists()||textContains("型 | 摩登时代").exists()||textContains("） | 要抱抱").exists()||textContains("喋血战士").exists()||textContains("） | 屠杀").exists()||textContains("0 | 渐变迪斯").exists()||textContains("席德.米德").exists()||textContains("） | 野蛮剑齿虎").exists()||textContains("） | 往日行动").exists()||textContains("） | 汪之").exists()||textContains("梦魇").exists()||textContains("） | 黄夹").exists()||textContains("） | 次时代").exists()||textContains("双涡轮").exists()||textContains("7 | 正义").exists()||textContains("意式拉力").exists()||textContains("枪 | 么么").exists()||textContains("0 | 迷人幻象").exists()||textContains("） | 么么").exists()||textContains("） | 迷人幻象").exists()||textContains("3 | 次时代").exists()||textContains("9 | 复仇者").exists()||textContains("5 | 黄夹克").exists()||textContains("斯 | 雅典娜").exists()||textContains("枪 | 吞噬").exists())//||textContains("） | 往日行动").exists()||textContains("） | 九头蛇").exists()||textContains("渐变迪斯").exists()||textContains("） | 渐变迪斯").exists()||textContains("1 | 行刑者").exists()||textContains("） | 湖怪鸟").exists()||textContains("0 | 玩具盒子").exists()||textContains("） | 金粉").exists()||textContains("） | 幽幻深渊").exists()||textContains("） | 瓜瓜").exists()||textContains("） | 幽幻深渊").exists()
        {
         buy018();
         buy019();
         buy020();       
