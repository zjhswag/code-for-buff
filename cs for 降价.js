...
// }
    ...
    if(textContains("暮光星系").exists())
    {
        ...
        //     }
            ...
            else if(textContains("版 | 破颚者").exists()||textContains("P2000（StatTrak™） | 珊瑚树").exists())
            {
                buy007();
                buy008();
                buy009();    
        ...
        if(textContains("确认付款").findOne(3000))
            ...
            else if(textContains("凯门鳄").exists()||textContains("型 | 零食派对").exists()||textContains("） | 九头蛇").exists()||textContains("） | 金粉").exists()||textContains("3 | 次时代").exists()||textContains("屠杀者").exists()||textContains("0 | 渐变迪斯科").exists()||textContains("） | 奥林匹斯").exists())//
            {
                buy007();
                buy008();
                // toast("00-01 07-08");                                                                                  
    ...
    if(textContains("确认付款").findOne(3000))
      ...
      else if(textContains("前线迷雾").exists()||textContains("） | 速度激情").exists()||textContains("型 | 破碎铅秋").exists()||textContains("遥控").exists()||textContains("7 | 可燃冰").exists())
// high prior||textContains("） | 大佬").exists()||textContains("7 | 混沌点阵").exists()
      ...
      else if(textContains("电子蜂巢").exists()||textContains("） | 残影").exists()||textContains("） | 宁静").exists()||textContains("5 | 相柳").exists())//||textContains("5 | 相柳").exists()
      {  
        buy003();
        breakbuy();
        toast('00-03');
      ...
      if(textContains("确认付款").findOne(6000))
        ...
        else if(textContains("0 | 变态杀戮").exists()||textContains("5 | 野孩子").exists())
         {
          ...
          else if(textContains("G | 动量").exists()||textContains("AUG（StatTrak™） | 动量").exists()||textContains("） | 吞噬").exists()||textContains("） | 雅典娜之眼").exists()||textContains("R | 经济").exists()||textContains("） | 汪之萌杀").exists()||textContains("） | 小绿怪").exists()||textContains("耍猴把戏").exists()||textContains("） | 荒野公主").exists()||textContains("G | 燕群").exists()||textContains("5 | 野蛮剑齿虎").exists()||textContains("4 | 要抱抱").exists()||textContains("枪 | 荒野公主").exists()||textContains("0 | 浅坟").exists()||textContains("） | 迷人幻象").exists()||textContains("） | 么么").exists()||textContains("牛 | 买定离手").exists()||textContains("枪 | 美洲驼炮").exists())//||textContains("G | 燕群").exists()
          {    
              buy003();
              buy008();
              buy009();
          ...
          else if(textContains("红色层压板").exists()||textContains("） | 樱花").exists()||textContains("） | 燕群").exists()||textContains("0 | 往日行动").exists()||textContains("G | 汪之萌杀").exists()||textContains("） | 野蛮剑齿虎").exists()||textContains("0 | 二西莫夫").exists()||textContains("银装素裹").exists()||textContains("） | 灯神").exists()||textContains("7 | 正义").exists()||textContains("） | 席德").exists()||textContains("G | 湖怪鸟").exists()||textContains("P | 死神").exists()||textContains("0 | 迷人幻象").exists()||textContains("枪 | 么么").exists()||textContains("G | 席德.米德").exists()||textContains("） | 买定离手").exists()||textContains("） | 齿仙").exists()||textContains("枪 | 吞噬").exists()||textContains("P | 金粉").exists()||textContains("） | 要抱抱").exists()||textContains("0 | 至尊威龙").exists()||textContains("0 | 血腥运动").exists()||textContains("） | 正义").exists()||textContains("斯 | 雅典娜之眼").exists()||textContains("） | 磷光体").exists()||textContains("UMP-45（StatTrak™） | 动量").exists()||textContains("） | 血腥运动").exists()||textContains("） | 浅坟").exists()||textContains("4 | 埋葬之影").exists()||textContains("4 | 齿仙").exists()||textContains("5 | 动量").exists()||textContains("D | 磷光体").exists()||textContains("鹰 | 机械工业").exists())      
          {
            buy003();
            buy009();
            buy008();
   ...
   else if(textContains("） | 爆裂食物").exists()||textContains("） | 摩登时代").exists()||textContains("星 | 樱花").exists()||textContains("） | 相柳").exists()||textContains("） | 大佬龙").exists()||textContains("9 | 爆裂食物").exists()||textContains("型 | 摩登时代").exists()||textContains("） | 美洲驼炮").exists()||textContains("） | 往日行动").exists())//席德
          {
            buy003(); 
            buy008();
            toast('00-03,07-08');
    ...
    else if(textContains("枪 | 奥林匹斯").exists()||textContains("0 | 玩具盒子").exists()||textContains("5 | 黄夹克").exists()||textContains("0 | 精雕木刻").exists()||textContains("） | 黄夹克").exists()||textContains("） | 次时代").exists()||textContains("） | 复仇者").exists()||textContains("斯 | 灯神").exists()||textContains("7 | 童话城堡").exists()||textContains("版 | 小绿怪").exists())//||textContains("G | 燕群").exists()
    {
        buy008();
        buy009();
        toast('00-02,07-09');
...
else if(textContains("受限").exists())//915
{
    ...
    else if(textContains("诅咒").exists()||textContains("） | 古董枪").exists()||textContains("） | 翼蜥").exists()||textContains("铁血玫瑰").exists()||textContains("牛 | 古董枪").exists()||textContains("） | 杀意大名").exists()||textContains("7 | 轨道").exists()||textContains("冥界之").exists()||textContains("林间").exists()||textContains("P | 火卫一").exists()||textContains("盲点").exists()||textContains("0 | 死亡之握").exists()||textContains("） | 蓝色层压板").exists()||textContains("星 | 惊惧骷髅").exists()||textContains("次时代").exists()||textContains("数字架构师").exists()||textContains("棱彩阶梯").exists()||textContains("斯 | 电子脉冲").exists()||textContains("） | 西装革履").exists()||textContains("） | 帝国").exists()||textContains("P | 蠕虫之神").exists()||textContains("8 | 浮生如梦").exists()||textContains("4 | 杀意大名").exists()||textContains("版 | 地狱门票").exists()||textContains("） | 崩络克").exists()||textContains("） | 富士山").exists())//||textContains("4 | 西装革履").exists()||textContains("4 | 特克卢").exists()
    {
       buy001();  
       toast('00-01 啊');
       breakbuy();      
    }
     else if(textContains("） | 隐伏帝王龙").exists()||textContains("血红蛋白").exists()||textContains("射线").exists()||textContains("金砖").exists()||textContains("幕后主谋").exists()||textContains("犯罪现场").exists()||textContains("4 | 狮鹫").exists()||textContains("花纹钢板").exists()||textContains("铜色星系").exists()||textContains("钛片").exists()||textContains("错觉").exists()||textContains("橙红安").exists()||textContains("） | 地狱门票").exists()||textContains("红色 DD").exists()||textContains("7 | 海之泡沫").exists()||textContains("） | 轻轨").exists()||textContains("鹰 | 轻轨").exists()||textContains("夜空沙暴").exists()||textContains("雅藤如嫣").exists()||textContains("） | 狮鹫").exists()||textContains("） | 火卫一").exists()||textContains("） | 钢铁禁锢").exists()||textContains("富兰克林").exists()||textContains("烧尽").exists()||textContains("遗产").exists()||textContains("0 | 翡翠色调").exists()||textContains("型 | 翼蜥").exists()||textContains("地狱看门犬").exists()||textContains("） | 蠕虫之神").exists()||textContains("太古传说").exists()||textContains("远古幻想").exists()||textContains("鬼脸天蛾").exists()||textContains("） | 祥和之翼").exists()||textContains("） | 猫猫狗狗").exists()||textContains("） | 夜无眠").exists()||textContains("型 | 隐伏帝王龙").exists()||textContains("型 | 崩络克").exists()||textContains("型 | 核子花园").exists()||textContains("型 | 夜无眠").exists()||textContains("钴蓝石英").exists()||textContains("9 | 晶红石英").exists()||textContains("型（StatTrak™） | 城里的月光").exists()||textContains("） | 浮生如梦").exists())
     ...
     else if(textContains("牛 | 水蓝条纹").exists()||textContains("） | 海斗士").exists()||textContains("塔 | 海斗士").exists()||textContains("） | 皇家军团").exists()||textContains("型 | 皇家军团").exists()||textContains("指挥").exists()||textContains("8 | 幽灵战士").exists()||textContains("塔 | 皇室伴侣").exists()||textContains("0 | 炽热").exists()||textContains("） | 探员").exists()||textContains("） | 手炮").exists()||textContains("P | 亡灵之主").exists()||textContains("） | 冷石").exists()||textContains("R | 冷石").exists()||textContains("型 | 闪回").exists()||textContains("斯 | ZX81").exists()||textContains("） | 圆影").exists()||textContains("消音型（StatTrak™） | 闪回").exists()||textContains("彼岸花").exists()||textContains("P | 猫猫狗狗").exists()||textContains("鹰 | 后发制人").exists()||textContains("7 | 复古浪潮").exists()||textContains("7 | 墨岩").exists()||textContains("7 | 三位一体").exists()||textContains("） | 火线冲锋").exists())//||textContains("） | 猫猫狗狗").exists()
     //只买0.07 和0.00  ||textContains("） | 速递").exists()
     {
         toast('00-07');         
         breakbuy();
     }
    else if(textContains("响尾蛇").exists()||textContains("） | 金铋辉煌").exists()||textContains("不可磨灭").exists()||textContains("） | 抖枪").exists()||textContains("枪 | 重新启动").exists()||textContains("） | 水蓝条纹").exists()||textContains("病毒危机").exists()||textContains("MAG-7（StatTrak™） | 炽热").exists()||textContains("0 | 销声").exists()||textContains("） | 酸蚀").exists()||textContains("牛 | 路霸").exists()||textContains("星 | 一见青心").exists()||textContains("塔 | 灾难").exists()||textContains("） | 蚀刻领主").exists()||textContains("） | 销声").exists()||textContains("MAC-10（StatTrak™） | 炽热").exists()||textContains("型 | 鼬鼠").exists()||textContains("7 | 渐变之色").exists()||textContains("） | 黯翼").exists()||textContains("4 | 星级").exists()||textContains("型 | 氮化处理").exists())
    {
        buy008();
        toast('00 07-08');
        breakbuy();
    ...
    if(textContains("水中之血").exists()||textContains("霓虹革命").exists())
        ...
        if(textContains("确认付款").findOne(3000))
           ...
           else if(textContains("型 | 子弹皇后").exists()||textContains("斯 | 防滚").exists()) //||textContains("） | 迷人眼").exists()||textContains("9 | 星使").exists()
           {
               //买00 07
               buy007();
               toast("00 07");
        ...
        //    }
           ...
           else if(textContains("型 | 暴怒野兽").exists()||textContains("4 | 弹雨").exists())
           {
               buy002();
               buy003();
               buy007();
